...
pub async fn record_extract_succeeded(
    ...
    append_audio_event(
        ...
        Event::ArtifactAudioExtractSucceeded(ArtifactAudioExtractSucceededPayload {
            ...
            source_media_snapshot_id: voom_core::MediaSnapshotId(event.source_media_snapshot_id),
            source_bundle_id: event.input.source_bundle_id,
            artifact_handle_id: event.artifact_handle_id,
            artifact_location_id: event.artifact_location_id,
            staging_path,
...
fn extract_output_payload(
    ...
    ArtifactAudioExtractOutputPayload {
        ...
        artifact_handle_id: output.staged_artifact_handle_id,
        artifact_location_id: output.staged_artifact_location_id,
        ...
        result_file_asset_id: voom_core::FileAssetId(output.result_file_asset_id),
...
fn transcode_started_payload(
    ...
    ArtifactAudioTranscodeStartedPayload {
        ...
        source_media_snapshot_id: voom_core::MediaSnapshotId(source_media_snapshot_id),
        staging_path,
...
fn transcode_succeeded_payload(
    ...
    ArtifactAudioTranscodeSucceededPayload {
        ...
        lease_id: Some(input.lease_id),
        source_file_version_id: input.source_file_version_id,
        source_file_location_id: context.source_location,
        source_media_snapshot_id: voom_core::MediaSnapshotId(context.source_media_snapshot),
        artifact_handle_id: context.artifact_handle,
        artifact_location_id: context.artifact_location,
        staging_path,
        selected_streams,
...
fn transcode_failed_payload(
    ...
    ArtifactAudioTranscodeFailedPayload {
        ...
        source_file_version_id: event.input.source_file_version_id,
        source_file_location_id: event.source_location_id,
        source_media_snapshot_id: event
            .source_media_snapshot_id
            .map(voom_core::MediaSnapshotId),
        artifact_handle_id: event.artifact_handle_id,
        artifact_location_id: event.artifact_location_id,
