...
pub enum EventKind {
    ...
    NodeMarkedStale,
    NodeRetired,
    NodeIncarnationActivated,
    NodeIncarnationEnded,
    StorageRootCreated,
    ...
    StorageRootRetired,
    ScanSessionRequested,
    ScanSessionStarted,
    ScanObservationBatchAccepted,
    ScanSessionSucceeded,
    ScanSessionFailed,
    ...
    ArtifactCommitIntentRecorded,
    ArtifactCommitIntentAuthorized,
    ArtifactCommitReceiptReported,
    ...
    FileLocationRootedRecorded,
    FileLocationAliased,
    FileLocationRootedAliased,
    FileLocationRetiredByMove,
    FileLocationRecordedByMove,
    FileLocationRootedRecordedByMove,
...
impl EventKind {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NodeIncarnationActivated => "node.incarnation_activated",
            Self::NodeIncarnationEnded => "node.incarnation_ended",
            ...
            Self::ScanSessionRequested => "scan_session.requested",
            Self::ScanSessionStarted => "scan_session.started",
            Self::ScanObservationBatchAccepted => "scan_session.observation_batch_accepted",
            Self::ScanSessionSucceeded => "scan_session.succeeded",
            Self::ScanSessionFailed => "scan_session.failed",
            Self::ScanSessionCancelled => "scan_session.cancelled",
            Self::ScanSessionStale => "scan_session.stale",
            ...
            Self::ArtifactCommitIntentRecorded => "artifact.commit_intent_recorded",
            Self::ArtifactCommitIntentAuthorized => "artifact.commit_intent_authorized",
            Self::ArtifactCommitReceiptReported => "artifact.commit_receipt_reported",
            ...
            Self::ArtifactAudioExtractQuiesced => "artifact.audio_extract_quiesced",
            ...
            Self::FileLocationRootedRecorded => "file_location.rooted_recorded",
            Self::FileLocationAliased => "file_location.aliased",
            Self::FileLocationRootedAliased => "file_location.rooted_aliased",
            ...
            Self::FileLocationRootedRecordedByMove => "file_location.rooted_recorded_by_move",
    ...
    pub fn from_str(s: &str) -> Result<Self, VoomError> {
        Ok(match s {
            ...
            "node.incarnation_activated" => Self::NodeIncarnationActivated,
            "node.incarnation_ended" => Self::NodeIncarnationEnded,
            ...
            "scan_session.requested" => Self::ScanSessionRequested,
            "scan_session.started" => Self::ScanSessionStarted,
            "scan_session.observation_batch_accepted" => Self::ScanObservationBatchAccepted,
            "scan_session.succeeded" => Self::ScanSessionSucceeded,
            "scan_session.failed" => Self::ScanSessionFailed,
            "scan_session.cancelled" => Self::ScanSessionCancelled,
            "scan_session.stale" => Self::ScanSessionStale,
            ...
            "artifact.commit_intent_recorded" => Self::ArtifactCommitIntentRecorded,
            "artifact.commit_intent_authorized" => Self::ArtifactCommitIntentAuthorized,
            "artifact.commit_receipt_reported" => Self::ArtifactCommitReceiptReported,
            ...
            "artifact.audio_extract_quiesced" => Self::ArtifactAudioExtractQuiesced,
            ...
            "file_location.rooted_recorded" => Self::FileLocationRootedRecorded,
            "file_location.aliased" => Self::FileLocationAliased,
            "file_location.rooted_aliased" => Self::FileLocationRootedAliased,
            ...
            "file_location.rooted_recorded_by_move" => Self::FileLocationRootedRecordedByMove,
