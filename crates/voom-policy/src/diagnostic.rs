...
impl DiagnosticCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NumericLiteralOutOfRange => "numeric_literal_out_of_range",
            ...
            Self::DuplicateConfigSetting => "duplicate_config_setting",
            ...
            Self::InvalidMetadataRequiresTools => "invalid_metadata_requires_tools",
