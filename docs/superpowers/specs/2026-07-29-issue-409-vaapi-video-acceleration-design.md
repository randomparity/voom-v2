...
Date: 2026-07-29
Issue: #409
ADR: [0052 — VAAPI device identity is the PCI address, and capability is probe-proven](../../adr/0052-vaapi-device-identity-and-probe-proven-capability.md)
...
| `codec_levels` | `&[]` (rejected — see ADR 0052 §4) |
...
concurrent encodes — and is recorded in ADR 0052's Consequences.
...
`check-adr-index` hard-gates this PR and ADR 0052's index row ships with it.
