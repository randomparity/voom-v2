...
| Compliance report fixture records remux execution eligibility | `cargo test -p voom-plan fixtures_test`; golden report `crates/voom-plan/fixtures/reports/remux_track_selection.json`. |
