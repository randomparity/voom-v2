...
## Codebase Intelligence for voom-v2 (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-26 (commit e6784d50). Confidence: 100%.
...
### Architecture
**Files:** 1129 | **Lines:** 355106 | **Monorepo:** 23 packages | **Import cycles:** 47
voom-v2 is a multi-package rust codebase of 1129 files, split across 23 packages. Execution starts at crates/voom-api/src/main.rs, crates/voom-api/src/server.rs, crates/voom-backup-worker/src/main.rs and 35 other entry points. Start here when reading the codebase. Ranked by PageRank over the import graph: the files most of the codebase ultimately depends on.

### Key modules
- `crates/voom-core/src` — crates/voom-core/src · crates/voom-core/src/media · crates/voom-core/src/runtime
**Language:** rust | **Files:** 12 | **Public symbols:**…
- `crates/voom-policy/src` — crates/voom-policy/src · crates/voom-policy/src/compile · crates/voom-policy/src/compile/lower ·…
- `crates/voom-worker-protocol/src` — crates/voom-worker-protocol/src · crates/voom-worker-protocol/src/http · crates/voom-worker-protocol/src/low_level
**Language:** rust |…
- `crates/voom-events/src` — crates/voom-events/src
**Language:** rust | **Files:** 5 | **Public symbols:** 22 / 190
Covers the 5 source files in crates/voom-events/src
- `crates/voom-cli` — crates/voom-cli · crates/voom-cli/src
**Language:** rust | **Files:** 6 | **Public symbols:** 182 / 678
Covers the 6 source files in 2…
- `crates/voom-plan/src` — crates/voom-plan/src · crates/voom-plan/src/compliance
**Language:** rust | **Files:** 11 | **Public symbols:** 202 / 430
Covers the 11…
- `crates/voom-core/src/taxonomy` — crates/voom-core/src/taxonomy
**Language:** rust | **Files:** 13 | **Public symbols:** 155 / 385
Covers the 13 source files in…
- `crates/voom-policy/src/data` — crates/voom-policy/src/data · crates/voom-policy/src/syntax
**Language:** rust | **Files:** 8 | **Public symbols:** 144 / 323
Covers the 8…
- `crates/voom-worker-protocol/src/operations` — crates/voom-worker-protocol/src/operations
**Language:** rust | **Files:** 10 | **Public symbols:** 343 / 402
Covers the 10 source files in…
- `crates/voom-store/src/repo/execution` — crates/voom-store/src/repo/execution
**Language:** rust | **Files:** 14 | **Public symbols:** 673 / 1014
Covers the 14 source files in…

### Entry points
- `crates/voom-cli/src/cli.rs`
- `crates/voom-api/src/server.rs`
- `crates/voom-mkvtoolnix-worker/src/main.rs`
- `crates/voom-backup-worker/src/main.rs`
- `crates/voom-ffmpeg-worker/src/main.rs`
- `crates/voom-hash-worker/src/main.rs`

### Files that need care (bug-fix history first, then churn — check `get_risk` before editing)
- `crates/voom-plan/src/planner_test.rs` — 26 bug fixes, last fix 4 weeks ago (bug magnet); 37 commits/90d
- `crates/voom-control-plane/src/audio/mod.rs` — 18 bug fixes, last fix 3 weeks ago (bug magnet); 43 commits/90d
- `crates/voom-node-agent/src/runtime_test.rs` — 13 bug fixes, last fix yesterday (bug magnet); 23 commits/90d
- `crates/voom-node-agent/src/runtime.rs` — 13 bug fixes, last fix yesterday (bug magnet); 17 commits/90d
- `crates/voom-control-plane/src/workflow/execution/executor/mod_test.rs` — 13 bug fixes, last fix today (bug magnet); 70 commits/90d

### Code health
Three co-equal signals: defect risk 6.37/10 avg, hotspot health 4.24/10 (stable), worst `crates/voom-store/src/repo/media/identity.rs` at 1.08/10 · maintainability 7.65/10 · performance risk 666 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `crates/voom-policy/src/data/model.rs` — complex conditional (validate_empty_scan_input) — impact −2.5
- `crates/voom-control-plane/src/artifact/verify.rs` — complex conditional (require_matching_policy_verification) — impact −2.5
- `crates/voom-store/src/repo/media/artifacts/mod.rs` — churn risk — impact −2.4
- `crates/voom-api/src/lib.rs` — change entropy — impact −2.1
- `crates/voom-events/src/kind_test.rs` — change entropy — impact −2.0
